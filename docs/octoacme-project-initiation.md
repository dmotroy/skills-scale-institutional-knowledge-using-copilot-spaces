...
- Proposed team / roles: _(list all roles needed: PM, PdM, Developer(s), DevOps Engineer, UX Designer, Security Lead, Data Analyst, Support/Customer Success — include only roles relevant to this project)_
